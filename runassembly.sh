...
./run2.sh /scratch/groups/mschatz1/mkirsche/ultralong/ccs/maternal_and_unknown.contigs.mmpoa.fa /scratch/groups/mschatz1/mkirsche/ultralong/rel2wt_50kplus.ctg.fa /scratch/groups/mschatz1/mkirsche/ultralong/ccs/AssemblyToMaternal.paf /scratch/groups/mschatz1/mkirsche/ultralong/ccs/maternal_and_unknown.contigs.mmpoa.scaffoldsassemblygraph.fa | tee maternal.log;
