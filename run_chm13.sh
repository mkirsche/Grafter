...
java -cp src Main aln_fn='/scratch/groups/mschatz1/mkirsche/minimap_t2t-chm13.20200602_'$readfilter.paf fasta_fn=$contigsfn read_fn='/scratch/groups/mschatz1/mkirsche/'rel5_$readfilter.fastq read_map_file=$OUTDIR/'chm13_'$readfilter'_'$minq'_usefulreadsmap.paf' contig_map_file=$OUTDIR/'chm13_'$readfilter'_'$minq'_usefulcontigsmap.paf' out_file=$newcontigsfile minq=$minq full_out_gfa_fn=$OUTDIR/'scaffolds_'$readfilter'_'$minq'.full.gfa' joins_out_gfa_fn=$OUTDIR/'scaffolds_'$readfilter'_'$minq'.joins.gfa' min_weight_supp=150 min_weight=10
